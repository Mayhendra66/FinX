...
class TransactionMobileController extends Controller
{
    public function index(Request $request) 
    {
        ...
        return view('transactions.mobile.transactionMobile', compact(
            'transactions',
            'accounts',
            'categories'
        ));
    ...
    {
        return redirect()->route('transactionsmobile.index');
    }
